// ----------------------------------------------------------------------------
// Zoom Search Engine 7.1 (26/July/2017)
//
...
//
// Copyright (C) Wrensoft 2000-2016
//
	...
	if (Recommended == 1)
	{
		...
		{			
			...
			if (sep > -1)
			{
				...
				if (ToLowerSearchWords == 1 && rec_word.length > 0)
					rec_word = rec_word.toLowerCase();
